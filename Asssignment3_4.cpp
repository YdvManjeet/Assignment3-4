...
int main()
{
    Person person1;
    Person person2;
    person1.setPersonAge(8);
    person2.setPersonContactInfo(9899891897);

    Student Student1;
    Student Student2;
    Student1.getPersonAgeID();
    Student2.setPersonAge(21);

    Professor pr1;
    Professor pr2;
    pr1.setPersonName(" Richa");
    pr2.setPersonAge(43);

    Course c1;
    Course c2;
    c1.setCourseCode("PSY151");
    c2.setCourseTitle("Physics");

    Department d1;
    Department d2;
    d1.setDepartmentBudget(12000);
    d2.setDepartmentLocation("Gurugram");

    vector<Person *> people;

    Student *s1 = new Student("20/04/25", "Computer Science", 7.77);
    s1->setPersonName("Manjeet");
    s1->setPersonID(12134);
    s1->setPersonAge(19);
    s1->setPersonContactInfo(9899891897);

    Student *s2 = new Student("12/03/25", "Physics", 6.45);
    s2->setPersonName("Krish");
    s2->setPersonID(10434);
    s2->setPersonAge(12);
    s2->setPersonContactInfo(9899891923);

    Professor *p1 = new Professor("Computer Science", "01/06/2020", "Machine Learning");
    p1->setPersonName("Richa Singh");
    p1->setPersonID(98343);
    p1->setPersonAge(27);
    p1->setPersonContactInfo(9899893453);

    Professor *p2 = new Professor("Mathematics", "15/07/2018", "Algebra");
    p2->setPersonName("Raman yadav");
    p2->setPersonID(56789);
    p2->setPersonAge(25);
    p2->setPersonContactInfo(9346543987);
...
void testAssistantFunctionality()
{
    ...
    gradStudent->setPersonName("Lakshay");
